...
const WindCalcPdfReport = ({ inputs, outputs, projectName = 'Untitled Project', preparedBy = '' }: Props) => {
  const now = new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' });

  return (
    <Document title={`WindCalc Pro — ${projectName}`} author="WindCalc Pro">
      {/* Cover Page */}
      <Page size="LETTER" style={s.coverPage}>
        <View style={s.coverContent}>
          <Text style={s.coverTitle}>WindCalc Pro</Text>
          ...
          <View style={s.coverMeta}>
            ...
            {preparedBy && <Text style={s.coverMetaText}>Prepared by: {preparedBy}</Text>}
        ...
        <View style={{ ...s.footer, bottom: 30 }}>
          <Text style={{ color: colors.gray, fontSize: 7 }}>Generated by WindCalc Pro — For review by licensed PE</Text>
        </View>
      </Page>
      ...
      <Page size="LETTER" style={s.page}>
        <View style={s.header}>
          <Text style={s.headerTitle}>WindCalc Pro — {projectName}</Text>
        ...
        <View style={s.footer} fixed>
          <Text>WindCalc Pro — ASCE 7-22 Ch. 28</Text>
      ...
      <Page size="LETTER" style={s.page}>
        ...
        <Text style={s.disclaimer}>
          ...
          All results must be reviewed and approved by a licensed Professional Engineer. The Engineer of Record assumes full responsibility
          for the adequacy and applicability of these calculations to the specific project conditions.
        </Text>
