...
const features = [
  {
    icon: Shield,
    title: 'ASCE 7-22 Compliant',
    description: 'Full Chapter 28 Envelope Procedure with GCpf interpolation, zone mapping, and overhang calculations.',
  },
  {
    icon: Zap,
    title: 'Real-Time Results',
    description: 'Instant recalculation as you type. No "Calculate" button needed — results update in under 50ms.',
  },
  {
    icon: FileText,
    title: 'Export-Ready Reports',
    description: 'Professional PDF engineering reports with full derivation chains, ready for permit submittal.',
  },
  {
    icon: Calculator,
    ...
    <div className="container mx-auto px-6">
      <div className="text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          Every feature designed with engineering precision and code compliance in mind.
        </p>
      </div>
      <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {features.map((f) => (
          <div
            key={f.title}
            className="group rounded-lg border border-border bg-card p-6 shadow-card transition-all hover:border-primary/30 hover:shadow-glow"
          >
...
const steps = [
  ...
  { step: '03', title: 'Export Report', description: 'Generate stamped-ready PDF reports with full ASCE 7-22 derivation chains.' },
];
